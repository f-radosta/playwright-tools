...
async function loginAsAdmin(): Promise<void> {
    ...
    await page.goto(
        'https://apimpa.loc/login_check?user=test-tool-admin&expires=33297865200&hash=hx-zSxVnaeiVWLmmE-1vdiiSXU_WOZfldT7vlDfH6a0~RVmHT5SCRm0uA0q9V-ghnDGpWORxvhFBGeQ9yJXs2T4~'
    );
...
async function loginAsUser(): Promise<void> {
    ...
    // Perform actual login with full URL
    await page.goto(
        'https://apimpa.loc/login_check?user=test-testovic&expires=33297865200&hash=uNdTW6_tQ9wDhe-xg27iumK-anWNx6rCntdQrIJYD7Q~gGd5DWPd2nsurngPvG9AYTz-FDuB1vaqUqcMCoQgoyI~'
    );
    await page.waitForTimeout(3000); // Longer wait for login
