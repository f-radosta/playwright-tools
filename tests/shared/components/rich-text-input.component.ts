...
export class RichTextInputComponent {
   ...
   */
  constructor(private readonly parentLocator: Locator, private readonly fieldId?: string) {
    // Find the Quill editor container
    const quillContainer = this.parentLocator.locator('[data-controller="quill"]');
    ...
    if (fieldId) {
      ...
      this.textareaLocator = quillContainer.locator('textarea[data-quill-target="input"]');
    }
  }
